...
contract PermaBull is Context, IERC20, Ownable {
    ...
    address payable public treasuryWallet = payable(0x31b5B830a8B02D79b1933ce7aBDe74230BA3908e);// Replace wallet address
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityTokens = contractTokenBalance.mul(_liquidityFee).div(_liquidityFee.add(_treasuryFee));
    ...
    returns (uint256, uint256) {
        ...
        uint256 tMarketing = tAmount.div(100).mul(_treasuryFee);
